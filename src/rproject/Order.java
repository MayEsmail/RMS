...
///////////////////////////////////////////////////
     ...
     public Order(){
        ...
        ImageIcon muteIcon = new ImageIcon("D:\\Resuturant Project\\RProject\\src\\background.png");
    ...
    /////////////////////////////////////////////////////////////////////////////
        ...
        ReciptL= new JLabel("Recipt");
        ReciptL.setBounds(400, 10, 100, 50);
        ReciptL.setFont(new Font("magneto", Font.BOLD, 25));
        ReciptL.setForeground(Color.WHITE);
        ReciptL.setFont(new Font("Script MT Bold", Font.BOLD, 25));
        add(ReciptL);
      ...
      ///////////////////////////////////////////////////////////////////////
       ...
       //////////////////////////////////////////////////////////////////////
        ...
        reciptbtn = new JButton("Send Recipt");
        reciptbtn.setBounds(55,450, 160, 40);
        add(reciptbtn);
        ///////////////////////////////////////////////////////////////////////
        ...
        reciptList = new JList();
        reciptList.setBounds(400, 55, 350, 550);
        reciptList.setBackground(Color.WHITE);
        reciptList.setForeground(Color.DARK_GRAY);
        add(reciptList);
        
        Printbtn= new JButton("Print");
        Printbtn.setBounds(680, 615, 70, 20);
        add(Printbtn);
    ...
    try{
    Connection con = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/resturant", "root", "19971997");
